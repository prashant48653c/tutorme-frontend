  ...
  return (
    <div className="w-full mt-7  flex flex-col items-center">
      ...
      <div className="w-max   my-6  text-center">
        <h2 className={`lg:text-5xl text-4xl leading-13 font-[800]  ${HoveFont.className}`}>
      ...
      <div className="flex items-center justify-center gap-8">
        ...
        <Button className=" min-w-[15rem] bg-gray-100 py-6 border-1 border-black hover:bg-green-200 hover:border-green-200 rounded-full text-black ">
          Visit Shop
        </Button>
      </div>
